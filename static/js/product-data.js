// Global variables to store product and visual content data
let productsData = [];
let visualsData = [];

// Function to load CSV data
// Load CSV data from root/data instead of static/data
async function loadCSVData() {
  try {    
    const productResponse = await fetch('/data/product.csv');
    const productCSV = await productResponse.text();
    
    const visualResponse = await fetch('/data/visualcontent.csv');
